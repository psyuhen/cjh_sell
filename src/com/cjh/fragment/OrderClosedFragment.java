...
public class OrderClosedFragment extends Fragment implements OnClickListener {
	private Logger LOGGER = LoggerFactory.getLogger(OrderClosedFragment.class);
...
/*	public static OrderClosedFragment newInstance() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		orderItemAdapter.setFrom("OrderClosedFragment");
...
//					orderItem.setBuyer_user_mobile(order.getBuyer_phone());
		...
		protected void onPostExecute(List<OrderItem> result) {
			...
			OrderClosedFragment.this.start += PageUtil.LIMIT;//每次改变start的值 
	...
	private void getClosedOrderInfo(int start){
		...
		if(start == PageUtil.START){
			OrderClosedFragment.this.start = PageUtil.START;
		}
